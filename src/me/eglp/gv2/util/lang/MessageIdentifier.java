...
public interface MessageIdentifier extends LocalizedString {
	...
	public default MessageCreateBuilder createMessageBuilder(GraphiteLocalizable localizable, String... params) {
	...
	public default MessageCreateData createMessage(GraphiteLocalizable localizable, String... params) {
		return createMessageBuilder(localizable, params).build();
	}
