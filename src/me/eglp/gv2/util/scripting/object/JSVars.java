...
public class JSVars {
	...
	/**
	 * The NONE premium level (no premium level)
	 */
	public static final JSPremiumLevel PREMIUM_LEVEL_NONE = new JSPremiumLevel(PremiumLevel.NONE);

	/**
	 * The DONATOR premium level
	 */
	public static final JSPremiumLevel PREMIUM_LEVEL_DONATOR = new JSPremiumLevel(PremiumLevel.DONATOR);
