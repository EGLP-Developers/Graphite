...
public class CommandUpvote extends Command {
	...
	public void action(CommandInvokedEvent event) {
		...
		for(GraphiteVoteSource vs : Graphite.getVoteSources()) {
			b.addField(DefaultLocaleString.COMMAND_UPVOTE_FIELD_TITLE.getFor(event.getSender(), "site_name", vs.getName()), DefaultLocaleString.COMMAND_UPVOTE_FIELD_DESCRIPTION.getFor(event.getSender(), "upvote_url", vs.getUpvoteURL(), "site_name", vs.getName()), false);
		}
		event.reply(b.build());
	}
